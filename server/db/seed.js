...
async function seed() {
  ...
  await BlogPost.bulkCreate([
    ...
    }, 
    {
      ...
      content: 'Reading is good for your brain, but people dont read as much as they should!',
      category: 'Book'
    }, 
    {
      author:'LysI',
      title: 'Crypto this season',
      content: 'Getting started was hard but as I learnt more, it has become an important hobby!',
      category: 'Lifestyle'
    }, 
    {
      author:'TeddyP',
      title: 'Gym moves you should integrate into your workout!',
      content: 'I only recently became a gym lad but im going to tell you all how its possible! These simple moves have become a staple in my workouts. ',
      category: 'Gym'
    }, 
    {
      author:'Felicity',
      title: 'Is Madonna still a star still 35 years later?',
      content: 'She definitely is! Why would anyone think othewise #materialgorl',
      category: 'Music'
    }, 
    {
      author:'Hannah',
      title: 'Best yoga moves for a healthy mind',
      content: 'Meditation and staying at peace with your mind is tricky, but with these simple starter moves, you can become a yogi too.',
      category: 'Lifstyle'
    }
  ])
}
